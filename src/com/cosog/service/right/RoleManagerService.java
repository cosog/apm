...
private CommonDataService service;
	...
	public String getRoleList(Map map,Page pager) {
		...
		sqlBuffer.append(" select roleCode,roleName,roleFlag,roleFlagName,receiveSMS,receiveSMSName,receiveMail,receiveMailName,roleId,showLevel,remark from ( ");
		sqlBuffer.append(" select role_code as roleCode,role_name as roleName,"
				...
				+ "role_id as roleId,showLevel,remark from  tbl_role u where 1=1");
