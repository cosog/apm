...
@Entity
@Table(name = "tbl_pumpdeviceaddinfo")
public class PumpDeviceAddInfo implements java.io.Serializable{
	...
	public PumpDeviceAddInfo() {
		super();
	}

	public PumpDeviceAddInfo(Integer id, Integer wellId, String itemName, String itemValue, String itemUnit) {
		super();
		this.id = id;
		this.wellId = wellId;
