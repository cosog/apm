...
@Entity
@Table(name = "tbl_pipelinedeviceaddinfo")
public class PipelineDeviceAddInfo implements java.io.Serializable{
	...
	public PipelineDeviceAddInfo() {
		super();
	}
	
	public PipelineDeviceAddInfo(Integer id, Integer wellId, String itemName, String itemValue, String itemUnit) {
		super();
		this.id = id;
		this.wellId = wellId;
