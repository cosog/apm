Ext.define('AP.store.alarmQuery.PumpSwitchingValueAlarmOverviewStore', {
    extend: 'Ext.data.Store',
    alias: 'widget.pumpSwitchingValueAlarmOverviewStore',
    ...
    listeners: {
        load: function (store, record, f, op, o) {
            ...
            Ext.getCmp("PumpSwitchingValueAlarmOverviewColumnStr_Id").setValue(column);
...
//                	displayMsg: '当前 {0}~{1}条  共 {2} 条'
                ...
                gridPanel = Ext.create('Ext.grid.Panel', {
                    id: "PumpSwitchingValueAlarmOverviewGridPanel_Id",
                    border: false,
//                    autoLoad: true,
                    bbar: bbar,
                    columnLines: true,
                ...
                var panel = Ext.getCmp("PumpSwitchingValueAlarmOverviewPanel_Id");
                panel.add(gridPanel);
            }
            if(get_rawData.totalCount>0){
            	...
            	var gridPanel = Ext.getCmp("PumpSwitchingValueAlarmGridPanel_Id");
                if (isNotVal(gridPanel)) {
                	Ext.getCmp("PumpSwitchingValueAlarmDetailsPanel_Id").remove(gridPanel);
                }
            }
        },
