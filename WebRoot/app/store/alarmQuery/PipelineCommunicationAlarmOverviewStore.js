Ext.define('AP.store.alarmQuery.PipelineCommunicationAlarmOverviewStore', {
    extend: 'Ext.data.Store',
    alias: 'widget.PipelineCommunicationAlarmOverviewStore',
    ...
    listeners: {
        load: function (store, record, f, op, o) {
            ...
            Ext.getCmp("PipelineCommunicationAlarmOverviewColumnStr_Id").setValue(column);
...
//                	displayMsg: '当前 {0}~{1}条  共 {2} 条'
                ...
                gridPanel = Ext.create('Ext.grid.Panel', {
                    id: "PipelineCommunicationAlarmOverviewGridPanel_Id",
                    border: false,
//                    autoLoad: true,
                    bbar: bbar,
                    columnLines: true,
                ...
                var panel = Ext.getCmp("PipelineCommunicationAlarmOverviewPanel_Id");
                panel.add(gridPanel);
            }
            if(get_rawData.totalCount>0){
            	...
            	var gridPanel = Ext.getCmp("PipelineCommunicationAlarmGridPanel_Id");
                if (isNotVal(gridPanel)) {
                	Ext.getCmp("PipelineCommunicationAlarmDetailsPanel_Id").remove(gridPanel);
                }
            }
        },
